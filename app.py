...
def handle_callback(call):
    ...
    if data == "close_msg":
        ...
        if data.startswith("c_n_s_"):
            ...
            # Country selection starts with the single premium emoji.
            # There is intentionally no fetching/loading text in this flow.
            reveal_msg_id, reveal_started_at = start_premium_reveal(chat_id, msg_id)
        ...
        # Local numbers are also revealed with the same single premium emoji.
        # API-backed requests recurse into c_n_s_ above and use it there.
        reveal_msg_id, reveal_started_at = start_premium_reveal(chat_id, msg_id)
