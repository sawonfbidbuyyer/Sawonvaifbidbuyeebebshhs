...
def bold_button_text(text):
    ...
    # Telegram keyboard labels are made bold and Latin labels are always caps.
    return str(text).upper().translate(_BOLD_BUTTON_TRANSLATION)
...
def bold_button_markup(reply_markup, chat_id=None):
    """Use the requested sans-bold font for every keyboard button."""
    if not reply_markup:
        return reply_markup
...
def language_selector_markup():
    return {"inline_keyboard": [
        [{"text": "ENGLISH", "icon_custom_emoji_id": "5913463998522592692", "callback_data": "set_lang_EN", "style": "primary"}],
        [{"text": "BANGLA", "icon_custom_emoji_id": "5911365056594973179", "callback_data": "set_lang_BN", "style": "success"}],
    ]}
...
def main_menu(user_id):
    kb = [
        ...
        [
            {"text": "CHANGE LANGUAGE", "icon_custom_emoji_id": "5913463998522592692", "style": "primary"}
        ]
    ]
    if is_admin(user_id): 
...
def handle_message(msg):
    ...
    MAIN_MENU_CMDS = ["GET NUMBER", "SEARCH NUMBER", "TRAFFIC", "REFER", "WITHDRAWAL", "SUPPORT", "CHANGE LANGUAGE", "ADMIN PANEL", "2FA ONLINE"]
