...
def normal_button_text(text):
    ...
    return str(text).translate(_NORMAL_BUTTON_TRANSLATION)

def bold_button_markup(reply_markup, chat_id=None):
    """Bold every visible keyboard button without changing callback data."""
    if not reply_markup:
        return reply_markup
...
def send_message(chat_id, text, reply_markup=None, parse_mode="HTML"):
    payload = {"chat_id": chat_id, "text": localize_ui_text(chat_id, text), "parse_mode": parse_mode, "disable_web_page_preview": True}
...
def send_photo(chat_id, photo_url_or_file_id, caption="", reply_markup=None, parse_mode="HTML"):
    payload = {"chat_id": chat_id, "photo": photo_url_or_file_id, "caption": localize_ui_text(chat_id, caption), "parse_mode": parse_mode}
    if reply_markup: payload["reply_markup"] = bold_button_markup(reply_markup, chat_id)
    return api_call("sendPhoto", payload)

def edit_message(chat_id, message_id, text, reply_markup=None, parse_mode="HTML"):
    payload = {"chat_id": chat_id, "message_id": message_id, "text": localize_ui_text(chat_id, text), "parse_mode": parse_mode, "disable_web_page_preview": True}
    if reply_markup: payload["reply_markup"] = bold_button_markup(reply_markup, chat_id)
